...
/**
 * Vreau sa trimit un mail inaintea si dupa terminarea unui job
 * @author Michael Minella
 */
public class JobListener implements JobExecutionListener { // poate fii facut si cu anotari

	private JavaMailSender mailSender; 

	public JobListener(JavaMailSender mailSender) { // JavaMailSender este dat de Spring Boot, tot ce fac e sa il preiau eu
	...
	private SimpleMailMessage getSimpleMailMessage(String subject, String text) {
		...
		mail.setTo("ceachi.bogdan@gmail.com");
