...
public class ListenerJobConfiguration {
	...
	@Bean
	public ItemReader<String> reader() { // de fiecare data apelat, imi returneaza cate un dasta, pe rand
	...
	public Step step1() {
		return stepBuilderFactory.get("step1")
				.<String, String>chunk(2)   // chunk based step, un chunk cu 2 metode
				.faultTolerant() // ca sa apelez reader, writer de mai multe ori
