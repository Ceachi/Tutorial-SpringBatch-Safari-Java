...
public class JobConfiguration {
	...
	public Step step1() {
		return stepBuilderFactory.get("step1")
				.<String, String>chunk(2) // nr per tranzactie
				.reader(statelessItemReader()) // primeste un obiect ce are implementata Interfata, reader() cred ca apeleaza metoda reader() din obiect
				// si ia pe rand ce returneaza pana cand o sa returneze null, apoi intra in writer, si incepem sa afisam din ea
				.writer(list -> {
